...
(describe "dequeue test"
          ...
          (it "should delete the back when the front is empty"
              (let [queue (dequeue (dequeue (enqueue (enqueue (enqueue (make-queue) 5) 10) 15)))]
                (should= (enqueue (enqueue (dequeue (enqueue (enqueue (make-queue) 10) 15)) 2) 3) (enqueue (enqueue queue 2) 3))))
