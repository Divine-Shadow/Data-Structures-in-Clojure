...
(describe "The push function"
          ...
          (it "should incement size when pushed"
              (let [s (Stack. '(2 3) 2)]
...
(describe "The pop function"
          ...
          (it "should remoce the front of the top"
              (let [s (Stack. '(1 2 3) 3)]
...
(describe "The peek function"
          ...
          (it "should return the last of the back if front is nil"
              (let [s (Queue. '(1 2 3) nil 3)]
                (should= 3 (peek s))))
          
          (it "should return nil for empty fronts and backs"
