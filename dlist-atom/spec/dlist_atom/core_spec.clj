...
(describe "insert-front"
          ...
          (it "should set the previous link" (let [p (dlist)] (should= (do (insert-front p 2) (insert-front p 3) (show-dlist-reverse p)) '(2 3) )))
...
(describe "insert-sorted"
          ...
          (it "should set the previous link" (let [p (dlist)] (should= (do (insert-last p 2) (insert-last p 5) (insert-sorted 4) (show-dlist p)) '(2 4 5) )))

          (it "should set the previous link" (let [p (dlist)] (should= (do (insert-last p 2) (insert-last p 3) (insert-sorted 5) (show-dlist-reverse p)) '(5 3 2) )))

          (it "should set the next link" (let [p (dlist)] (should= (do (insert-last p 2) (insert-last p 3) (insert-sorted 1) (show-dlist-reverse p)) '(3 2 1) )))
)


(describe" Index-forward "

(it "should find the index" (let [p (dlist)] (should= (do (insert-last p 2) (insert-last p 3) (insert-last 5) (Index-forward p 3)) 1))) 
)
(describe" Index-backward"
(it "should find the index" (let [p (dlist)] (should= (do (insert-last p 2) (insert-last p 3) (insert-last 5) (Index-backward p 3)) -1)))
)

(describe "delete" 

(it "should make a deletion" (let [p (dlist)] (should= (do (insert-last p 2) (insert-last p 6) (insert-last 5) (delete p 5) (show-dlist p)) '(2 6))))
(it "should make a deletion" (let [p (dlist)] (should= (do (insert-last p 2) (insert-last p 6) (insert-last 5) (delete p 2) (show-dlist p)) '(6 5))))

)

(describe "reverse"
(it "should fix forward edges" (let [p (dlist)] (should= (do (insert-last p 2) (insert-last p 6) (insert-last 5) (reverse p) (show-dlist p)) '(5 6 2))))
(it "should make a deletion" (let [p (dlist)] (should= (do (insert-last p 2) (insert-last p 6) (insert-last 5) (reverse p ) (show-dlist-reverse p)) '(2 6 5))))
)
